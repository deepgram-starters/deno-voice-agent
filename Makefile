...
.PHONY: help check-prereqs init install install-backend install-frontend build start start-backend start-frontend check test clean status update eject-frontend
